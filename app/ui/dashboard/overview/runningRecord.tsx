...
export default async function RunningRecord() {
  ...
  return (
    <div className='rounded-lg font-black text-3xl flex flex-col gap-8 items-center justify-center w-full lg:w-[450px] h-[450px] bg-sky-400 shadow-lg shadow-gray-400'>
      <div>총 달린 거리</div>
